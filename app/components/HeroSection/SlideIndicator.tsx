...
export default function SlideIndicator({ current, slides, onPrev, onNext, onGoTo }: SlideIndicatorProps) {
  ...
  return (
    <>
      {/* Mobile layout — arrows on the left, counter centered, dots on the right */}
      ...
      {/* Desktop layout — progress bars + counter/arrows under them */}
      <div className="hidden md:block absolute bottom-8 right-8 w-1/4 z-10 pointer-events-none">

...
export default function CommunityHero() {
  return (
    <section data-nav-theme="light" className="relative w-screen h-[60vh] md:h-screen md:min-h-176 flex items-center justify-center overflow-hidden">
      <Image src="/images/PhotoSection/photo-section6.webp" alt="Community Hero" fill priority sizes="100vw" className="pt-20 object-cover object-[center_60%]" />

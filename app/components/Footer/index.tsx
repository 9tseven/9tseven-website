...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#ebebeb] text-black overflow-hidden">
      ...
      {/* Big logo */}
      <div className="flex items-end justify-center overflow-hidden py-10" style={{ minHeight: "clamp(160px, 45vw, 660px)" }}>
        <img src="/Logo/9t7.svg" alt="9TSEVEN" className="w-[65%] md:w-[40%]" style={{ filter: "invert(1)" }} />
      </div>
    </footer>
  );
}

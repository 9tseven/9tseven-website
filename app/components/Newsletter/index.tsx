  ...
  return (
    <div id="newsletter" className="px-8 py-16 border-b border-ink/10">
      ...
      <form className="flex flex-col gap-2 md:flex-row md:gap-0" onSubmit={handleSubmit}>
        <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="ENTER EMAIL" className="font-mono flex-1 min-w-0 bg-white px-4 py-2 text-[16px] md:px-5 md:py-3 md:text-[0.75rem] tracking-label uppercase placeholder:text-ink-faint outline-none border border-ink/10" />

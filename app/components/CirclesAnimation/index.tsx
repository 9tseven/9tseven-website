  ...
  return (
    <div className="absolute" style={{ left: `${x}%`, top: `${y}%`, transform: "translate(-50%, -50%)" }}>
      <motion.div
        ...
        initial={{ backgroundColor: "rgba(0,0,0,0)", borderColor: "rgba(0,0,0,0.25)" }}
        animate={active ? { backgroundColor: "rgba(0,0,0,1)", borderColor: "rgba(0,0,0,1)" } : { backgroundColor: "rgba(0,0,0,0)", borderColor: "rgba(0,0,0,0.25)" }}
